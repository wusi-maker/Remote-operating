...
Rectangle{
    ...
    property int titleFontSize: 14  // 添加标题字体大小控制属性
    ...
    Row{
        ...
        FluText {
            ...
            font.pixelSize: control.titleFontSize  // 使用新的titleFontSize属性控制字体大小
            anchors.verticalCenter: parent.verticalCenter
        }
    }
    Component{
    ...
    //设置的每个组件有自己的固定大小，但是这样子无法适配不同大小的页面，故添加代码使其随iconsize大小变化
    RowLayout{
        ...
        FluIconButton{
            ...
            iconSize: control.iconSize * 0.6  // 使用控制器的iconSize属性，按比例缩放
            visible: showDark
        ...
        FluIconButton{
            ...
            Layout.alignment: Qt.AlignVCenter
            iconSize: control.iconSize * 0.56  // 使用控制器的iconSize属性，按比例缩放
            visible: {
                if(!(d.win instanceof FluWindow)){
                    return false
                }
        ...
        FluIconButton{
            ...
            Layout.alignment: Qt.AlignVCenter
            iconSize: control.iconSize * 0.44  // 使用控制器的iconSize属性，按比例缩放
            text:minimizeText
            radius: 0
        ...
        FluIconButton{
            ...
            radius: 0
            iconSize: control.iconSize * 0.4  // 使用控制器的iconSize属性，按比例缩放
